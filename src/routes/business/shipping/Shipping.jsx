          ...
          <div className=" delivery-box">
            ...
            <div className="delivery-vailed">
              ...
              <div>
                <h5>전 지역 가능</h5>
                <p>
                  서울, 안양시, 부천시, 구리시, 성남시, 수원시, 광명시,
                  의정부시, 안산시, 시흥시(안산시흥 공단지역 제외)
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  일산서구 – 일산동(일산1~3동), 주엽동(주엽1~2동), 가좌동,
                  덕이동, 대화동, 탄현동, 송산동, 송포동
                </p>
                ...
                <h6>하남시</h6>
                <p>
                  미사동(미사1~2동), 신장동(신장1~2동), 덕풍동(덕풍1~3동),
                  망월동, 선동, 풍산동, 창우동, 천현동, 학암동, 위례동
                </p>
                ...
                <h6>평택시</h6>
                <p>
                  고덕면, 팽성읍, 신장동, 독곡동, 지산동, 서정동, 이중동,
                  장안동, 도일동, 장당동, 가재동, 철괴동, 칠원동, 지제동,
                  세교동, 통복동, 평택동, 군문동, 합정동, 비전동, 소사동,
                  용이동, 죽백동, 동삭동
                </p>
              </div>
            </div>
